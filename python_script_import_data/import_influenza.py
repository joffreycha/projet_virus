<<<<<<< HEAD:python_script_import_data/import_influenza.py
...
for nom_fichier in liste_fichier:
    result = mycol.insert_many(generate_data(nom_fichier), True, True)  
...
# Envoie des données via l'api bulk sur elasticsearch
#Liste pour récupérer tout les fichiers de la grippe
>>>>>>> ddc83fe64e53661a2e87a0e61b2fcdc0d4e4052e:python_script_import_data/import_influenza_csv_es.py
